'use client';
import { useState, useActionState, useEffect, useRef, forwardRef } from 'react';
...
const InquirySection = forwardRef<HTMLDivElement>((props, ref) => {
...
InquirySection.displayName = 'InquirySection';
